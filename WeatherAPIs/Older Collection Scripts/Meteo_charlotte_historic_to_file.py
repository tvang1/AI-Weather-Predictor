...
#conn.request("GET", "/stations/daily?station=72314&start=2016-01-01&end=2022-02-02", headers=headers)
conn.request("GET", "/stations/daily?station=72314&start=2022-04-15&end=2022-04-16", headers=headers)
