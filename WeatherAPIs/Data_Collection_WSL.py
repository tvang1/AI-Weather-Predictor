...
def get_lines(name):
    if (name == "cr"):
        with open(r"/mnt/d/GitRepositories/Simple-Weather-Predictor/WeatherAPIs/API Outputs/castle_rock_data.csv", 'r') as fp:
            num_lines = sum(1 for line in fp if line.rstrip())
            return num_lines
    elif (name == "dv"):
        with open(r"/mnt/d/GitRepositories/Simple-Weather-Predictor/WeatherAPIs/API Outputs/denver_data.csv", 'r') as fp:
            num_lines = sum(1 for line in fp if line.rstrip())
            return num_lines
    elif (name == "bd"):
        with open(r"/mnt/d/GitRepositories/Simple-Weather-Predictor/WeatherAPIs/API Outputs/boulder_data.csv", 'r') as fp:
            num_lines = sum(1 for line in fp if line.rstrip())
            return num_lines
